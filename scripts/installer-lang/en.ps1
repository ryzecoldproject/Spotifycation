[PSCustomObject]@{
    Welcome         = "
╔═══════════════════════════════════════════╗
║ Welcome to Spotifycation RSMV for Windows ║
╚═══════════════════════════════════════════╝"
    ...
    NewV2           = "Your Spotify version ({0}) has not been tested. The stable version for Spotifycation is {1}"
    ...
    Spicetify       = "Spicetify detected, it must be installed after Spotifycation, open recommended actions in FAQ ? [Y/N]"
    NoRestore       = "Spotifycation has already been installed, xpui.bak not found. `nPlease uninstall Spotify client and run Install.bat again"
